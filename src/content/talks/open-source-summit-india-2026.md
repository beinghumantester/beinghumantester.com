...
date: "2026-06-17"
event: "Open Source Summit India 2026, Mumbai (The Linux Foundation)"
external_url: "https://events.linuxfoundation.org/open-source-summit-india/"
description: "Examining governance docs and contributor guidelines from Linux kernel, Kubernetes, Apache and OpenStack, this talk argues that investing in CI alone doesn't clarify who owns test health - and offers four practical steps for making testing ownership explicit."
tags:
  - "Open Source"
  - "Test Governance"
  - "CI-CD"
